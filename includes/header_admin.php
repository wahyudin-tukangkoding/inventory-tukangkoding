...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php"><i class="fa fa-stack-overflow fa-fw"></i>Inventory</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Account">
          ...
          <ul class="sidenav-second-level collapse" id="collapseSetting">
            <li>
              <a href="addUser.php"><i class="fa fa-fw fa-plus"></i>Add User</a>
            </li>
            <li>
              <a href="setting_admin.php"><i class="fa fa-fw fa-wrench"></i>Edit Account</a>
            </li>
            <li>
              <a href="manage_user.php"><i class="fa fa-fw fa-edit"></i>Manage Users </a>
            </li>
          </ul>
        </li>
      </ul>
